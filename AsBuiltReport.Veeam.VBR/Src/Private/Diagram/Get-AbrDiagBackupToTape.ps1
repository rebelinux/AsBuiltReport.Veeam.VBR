                    ...
                    foreach ($TSOBJ in ($BackupTapeServers | Sort-Object -Property Name)) {
                        ...
                        if ($BackupTapeLibrary) {
                            ...
                            foreach ($TSLibraryOBJ in $BKPTLOBJ) {
                                ...
                                try {
                                    $TapeLibrarySubgraph = Add-HtmlSubGraph -Name 'TapeLibrarySubgraph' -ImagesObj $Images -TableArray $TapeLibraryNodesArray -Align 'Center' -IconDebug $IconDebug -Label 'Tape Library' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize 1 -FontSize 24 -FontBold -TableBackgroundColor $MainGraphBGColor
                                } catch {
                        ...
                        try {
                            ...
                            $TapeLibrarySubgraphArray = Add-HtmlSubGraph -Name 'TapeLibrarySubgraphArray' -ImagesObj $Images -TableArray $TapeNodesArray -Align 'Center' -IconDebug $IconDebug -Label ' ' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '0' -ColumnSize $TapeLibraryColumnSize -FontBold -TableBackgroundColor $MainGraphBGColor
                        } catch {
                        ...
                        try {
                            $TapeServerSubgraph = Add-HtmlSubGraph -Name 'TapeServerSubgraph' -ImagesObj $Images -TableArray $TapeLibrarySubArrayTable -Align 'Center' -IconDebug $IconDebug -Label $TSOBJ.Name -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize 1 -FontSize 24 -FontBold -TableBackgroundColor $MainGraphBGColor
                        } catch {
