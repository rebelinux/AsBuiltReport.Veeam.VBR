function Get-AbrDiagBackupToViProxy {
    <#
    .SYNOPSIS
    ...
    process {
        try {
            $VMwareBackupProxy = Get-AbrBackupProxyInfo -Type 'vmware'
            if ($BackupServerInfo) {
