    ...
    process {
        ...
        if ($CCPerTenantInfo = Get-AbrBackupCCPerTenantInfo -TenantName $TenantName) {
            ...
            if (($CGPoolInfo = $CCPerTenantInfo.CloudGatewayPools) -and $CCPerTenantInfo.CloudGatewaySelectionType -eq 'GatewayPool') {
                ...
                try {
                    if ($CGPoolNode) {
                        ...
                        $CGPoolNodesSubGraph += Add-HtmlSubGraph -Name 'CGPoolNodesSubGraph' -ImagesObj $Images -TableArray $CGPoolNode -Align 'Center' -IconDebug $IconDebug -Label 'Gateway Pools' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize $CGPoolNodecolumnSize -FontSize 22 -IconType 'VBR_Cloud_Connect_Gateway_Pools' -FontBold -TableBackgroundColor $MainGraphBGColor
            ...
            if ($CCBackupStorageObj = $CCPerTenantInfo.BackupResources) {
                ...
                foreach ($CCBackupStorageInfo in $CCBackupStorageObj) {
                    ...
                    try {
                        if ($CloudConnectTenantBSArray) {
                            ...
                            $CloudConnectTenantBSSubGraph = Add-HtmlSubGraph -Name 'CloudConnectTenantBSSubGraph' -ImagesObj $Images -TableArray $CloudConnectTenantBSArray -Align 'Center' -IconDebug $IconDebug -Label 'Resources' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize $CloudConnectTenantBSArraycolumnSize -FontSize 22 -FontBold -TableBackgroundColor $MainGraphBGColor
                    ...
                    try {
                        $CloudRepoSubgraphNode += Add-HtmlSubGraph -Name 'CloudRepoSubgraphNode' -ImagesObj $Images -TableArray $CloudConnectTenantBRArray -Align 'Center' -IconDebug $IconDebug -Label $CCBackupStorageInfo.Name -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize 1 -FontSize 20 -FontBold -TableBackgroundColor $MainGraphBGColor
                    } catch {
                ...
                try {
                    $CloudRepoSubgraph = Add-HtmlSubGraph -Name 'CloudRepoSubgraph' -ImagesObj $Images -TableArray $CloudRepoSubgraphNode -Align 'Center' -IconDebug $IconDebug -Label 'Backup Resources' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize 4 -FontSize 22 -IconType 'VBR_Cloud_Storage' -FontBold -TableBackgroundColor $MainGraphBGColor
                } catch {
                    Write-PScriboMessage 'Error: Unable to create Cloud Resource SubGraph Nodes Objects. Disabling the section'
                    Write-PScriboMessage "Error Message: $($_.Exception.Message)"
                }
            ...
            if ($CCReplicaResourcesObj = $CCPerTenantInfo.ReplicationResources.HardwarePlanOptions) {
                    ...
                    if ($CCReplicaResourcesInfo.Name) {
                        ...
                        try {
                            if ($CloudConnectTenantRRArray) {
                                ...
                                $CloudConnectTenantRRSubGraph = Add-HtmlSubGraph -Name 'CloudConnectTenantRRSubGraph' -ImagesObj $Images -TableArray $CloudConnectTenantRRArray -Align 'Center' -IconDebug $IconDebug -Label 'Resources' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize $CloudConnectTenantRRArraycolumnSize -FontSize 22 -FontBold -TableBackgroundColor $MainGraphBGColor
                ...
                if ($CloudConnectTenantRRNetworkExtensionArray) {
                    try {
                        $CloudConnectTenantRRNExtensionSubgraphNode = Add-HtmlSubGraph -Name 'CloudConnectTenantRRNExtensionSubgraphNode' -ImagesObj $Images -TableArray $CloudConnectTenantRRNetworkExtensionArray -Align 'Center' -IconDebug $IconDebug -Label 'Network Extension Appliances' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize 4 -FontSize 22 -IconType 'VBR_Hardware_Resources' -FontBold -TableBackgroundColor $MainGraphBGColor
                    } catch {
                        Write-PScriboMessage 'Error: Unable to create Cloud Resource SubGraph Nodes Objects. Disabling the section'
                        Write-PScriboMessage "Error Message: $($_.Exception.Message)"
                    }
                ...
                try {
                    $CloudResourcesSubgraphNode = Add-HtmlSubGraph -Name 'CloudResourcesSubgraphNode' -ImagesObj $Images -TableArray $CloudConnectTenantRRArraySubgraph -Align 'Center' -IconDebug $IconDebug -Label 'Replica Resources' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize 4 -FontSize 22 -IconType 'VBR_Hardware_Resources' -FontBold -TableBackgroundColor $MainGraphBGColor
                } catch {
                    Write-PScriboMessage 'Error: Unable to create Cloud Resource SubGraph Nodes Objects. Disabling the section'
                    Write-PScriboMessage "Error Message: $($_.Exception.Message)"
                }
            ...
            if ($CCvCDReplicaResourcesObj = $CCPerTenantInfo.vCDReplicationResources.OrganizationvDCOptions) {
                ...
                foreach ($CCvCDReplicaResourcesInfo in $CCvCDReplicaResourcesObj) {
                    ...
                    try {
                        if ($CloudConnectTenantvCDRRArray) {
                            ...
                            $CloudConnectTenantvCDRRSubGraph = Add-HtmlSubGraph -Name 'CloudConnectTenantvCDRRSubGraph' -ImagesObj $Images -TableArray $CloudConnectTenantvCDRRArray -Align 'Center' -IconDebug $IconDebug -Label 'Resources' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize $CloudConnectTenantvCDRRArraycolumnSize -FontSize 22 -FontBold -TableBackgroundColor $MainGraphBGColor
                ...
                if ($CloudConnectTenantvCDRRNetworkExtensionArray) {
                    try {
                        $CloudConnectTenantvCDRRNExtensionSubgraphNode = Add-HtmlSubGraph -Name 'CloudConnectTenantvCDRRNExtensionSubgraphNode' -ImagesObj $Images -TableArray $CloudConnectTenantvCDRRNetworkExtensionArray -Align 'Center' -IconDebug $IconDebug -Label 'Network Extension Appliances' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize 4 -FontSize 22 -IconType 'VBR_Hardware_Resources' -FontBold -TableBackgroundColor $MainGraphBGColor
                    } catch {
                ...
                try {
                    $CloudvCDResourcesSubgraphNode = Add-HtmlSubGraph -Name 'CloudvCDResourcesSubgraphNode' -ImagesObj $Images -TableArray $CloudConnectTenantvCDRRArraySubgraph -Align 'Center' -IconDebug $IconDebug -Label 'vDC Replica Resources' -LabelPos 'top' -FontColor $Fontcolor -TableStyle 'dashed,rounded' -TableBorderColor $Edgecolor -TableBorder '1' -ColumnSize 4 -FontSize 22 -IconType 'VBR_Hardware_Resources' -FontBold -TableBackgroundColor $MainGraphBGColor
                } catch {
